...
var voornaam = "Phi "; // wijzig dit in jouw eigen voornaam
var tussenvoegsel = " "; // wijzig dit in jouw eigen eventuele tussenvoegsel
var achternaam = "Verbiest"; // wijzig dit in jouw eigen achternaam
...
var geboortemaand = "Februari"; // je geboortemaand
...
function myFunction(){
        ...
        var straat = "Hellemanstraat"; // je straat;
        var huisnummer = "76"; // je huisnummer;
        var woonplaats = "Deurne"; // je woonplaats;
